        ...
        <Row>
          <Col sm={12}>
          	...
          	<div className="cont">
                ...
                <li><a href="/elegi-plan-para-tu-equipo-sin-stock" target="_blank">Elegí Plan para tu equipo (sin stock)</a></li>
                ...
                <li><a href="/resumen-de-compra-sin-stock" target="_blank">Resumen de compra (Sin Stock)</a></li>
